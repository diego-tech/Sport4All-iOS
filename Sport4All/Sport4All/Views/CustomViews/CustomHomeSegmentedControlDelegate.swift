//
//  CustomHomeSegmentedControl.swift
//  Sport4All
//
...
protocol CustomHomeSegmentedControlDelegate: AnyObject {
	func change(to index: Int)
}

class CustomHomeSegmentedControl: UIView {
...
// Configuration View
extension CustomHomeSegmentedControl {
